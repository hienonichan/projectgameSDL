...
bool HomeState::loadState() {
	...
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/load.png", "loading", GameControl::getInstance()->getRenderer());
	...
	surface_logo = IMG_Load("C:/projectgameSDL/projectgameSDL/logo game.png");
