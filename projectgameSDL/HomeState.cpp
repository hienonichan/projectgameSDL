...
bool HomeState::loadState() {
	...
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/play.png", "startbutton", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/exit.png", "exitbutton", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/load.png", "loading", GameControl::getInstance()->getRenderer());
	...
	surface_logo = IMG_Load("C:/projectgameSDL/projectgameSDL/source_picture/logo game.png");
