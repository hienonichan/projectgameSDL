...
bool UpgradeState::loadState() {
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card1.png", "card1", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card2.png", "card2", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card3.png", "card3", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card4.png", "card4", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card5.png", "card5", GameControl::getInstance()->getRenderer());
	ObjectTextureManager::getInstance()->loadTexture("C:/projectgameSDL/projectgameSDL/source_picture/card6.png", "card6", GameControl::getInstance()->getRenderer());
	...
	std::string background = "C:/projectgameSDL/projectgameSDL/source_picture/anh ma mi.jpg";
	...
	TTF_Font* font = TTF_OpenFont("C:/projectgameSDL/projectgameSDL/source_ttf/LibreBaskerville-Bold.ttf", 30);
